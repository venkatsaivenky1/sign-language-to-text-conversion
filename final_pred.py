...
class Application:
    ...
    def __init__(self):
        ...
        self.root.configure(bg="#f7f1f0")  # Light lavender-beige
        ...
        # Color palette
        background_color = "#f7f1f0"       # Light lavender/beige
        panel_left = "#e8e0df"            # Slightly darker beige
        panel_right = "#ffffff"           # White
        text_color = "#3d3d3d"            # Dark grey
        accent_color = "#a389d4"          # Soft lavender
        highlight_color = "#ffe4b5"       # Light peach for attention
        button_bg = "#ece2f0"             # Soft lilac
        button_hover = "#d9cce0"

        # Common styling
        label_style = {"bg": background_color, "fg": text_color, "font": ("Segoe UI", 26, "bold")}
        entry_style = {"font": ("Segoe UI", 20), "bg": "#ffffff", "relief": "groove", "bd": 2, "fg": "#333333"}
        btn_style = {"font": ("Segoe UI", 14, "bold"), "bg": button_bg, "activebackground": button_hover,
                    "relief": "raised", "bd": 2, "fg": "#4b3f72"}

        # Title
        self.T = tk.Label(self.root, text="Sign Language To Text Conversion", **label_style)
        self.T.grid(row=0, column=0, columnspan=6, sticky="nsew", pady=(10, 20))

        # Camera Frame
        self.panel = tk.Label(self.root, relief="ridge", bd=2, bg=panel_left)
        self.panel.grid(row=1, column=0, rowspan=5, columnspan=3, sticky="nsew", padx=(20, 10), pady=10)

        # Processed Image Frame
        self.panel2 = tk.Label(self.root, relief="ridge", bd=2, bg=panel_right)
        self.panel2.grid(row=1, column=3, rowspan=5, columnspan=3, sticky="nsew", padx=(10, 20), pady=10)

        # Character Display
        self.T1 = tk.Label(self.root, text="Character:", font=("Segoe UI", 22, "bold"), bg=background_color, fg=text_color)
        self.T1.grid(row=6, column=0, sticky="e", padx=(20, 5), pady=5)

        self.panel3 = tk.Label(self.root, font=("Segoe UI", 40, "bold"), bg="#ffffff", fg=accent_color, relief="solid", bd=2)
        self.panel3.grid(row=6, column=1, columnspan=2, sticky="w", padx=(0, 10), pady=5)

        # Sentence Display
        self.T3 = tk.Label(self.root, text="Sentence:", font=("Segoe UI", 20, "bold"), bg=background_color, fg=text_color)
        self.T3.grid(row=7, column=0, sticky="e", padx=(20, 5), pady=5)

        self.panel5 = tk.Label(self.root, **entry_style, anchor="w")
        self.panel5.grid(row=7, column=1, columnspan=2, sticky="ew", padx=(0, 10), pady=5)

        # Speak & Clear Buttons
        self.clear = tk.Button(self.root, text="Clear", **btn_style, width=10, command=self.clear_fun)
        self.clear.grid(row=7, column=3, sticky="e", padx=10, pady=5)

        self.speak = tk.Button(self.root, text="Speak", **btn_style, width=10, command=self.speak_fun)
        self.speak.grid(row=7, column=4, sticky="w", padx=10, pady=5)

        # Suggestions Title
        self.T4 = tk.Label(self.root, text="Suggestions:", fg="#a14545", font=("Segoe UI", 20, "bold"), bg=background_color)
        self.T4.grid(row=8, column=0, sticky="e", padx=(20, 5), pady=(10, 5))

        # Suggestion Buttons
        suggestion_btn_style = btn_style.copy()
        suggestion_btn_style.update({"width": 14, "bg": highlight_color, "activebackground": "#ffd8a8", "fg": "#703c2e"})

        self.b1 = tk.Button(self.root, **suggestion_btn_style)
        self.b2 = tk.Button(self.root, **suggestion_btn_style)
        self.b3 = tk.Button(self.root, **suggestion_btn_style)
        self.b4 = tk.Button(self.root, **suggestion_btn_style)

        self.b1.grid(row=8, column=1, padx=5, pady=(10, 5), sticky="ew")
        self.b2.grid(row=8, column=2, padx=5, pady=(10, 5), sticky="ew")
        self.b3.grid(row=8, column=3, padx=5, pady=(10, 5), sticky="ew")
        self.b4.grid(row=8, column=4, padx=5, pady=(10, 5), sticky="ew")
